...
export const changeAddTag = payload => ({ payload, type: ADD_TAG });
export const changeRemoveTag = payload => ({ payload, type: REMOVE_TAG });
// TODOS - add other action creators
...
export default function reducer(statePart = [], action = {}) {
  switch (action.type) {
    ...
    // TODOS - handle other action types
